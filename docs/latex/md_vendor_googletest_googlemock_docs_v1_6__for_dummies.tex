...
\end{DoxyEnumerate}\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__for_dummies_autotoc_md447}{}\doxysection{Why Google Mock?}\label{md_vendor_googletest_googlemock_docs_v1_6__for_dummies_autotoc_md447}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__for_dummies_autotoc_md448}{}\doxysection{Getting Started}\label{md_vendor_googletest_googlemock_docs_v1_6__for_dummies_autotoc_md448}
Using Google \mbox{\hyperlink{class_mock}{Mock}} is easy! Inside your C++ source file, just {\ttfamily \#include} {\ttfamily \char`\"{}gtest/gtest.\+h\char`\"{}} and {\ttfamily \char`\"{}gmock/gmock.\+h\char`\"{}}, and you are ready to go.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__for_dummies_autotoc_md449}{}\doxysection{A Case for Mock Turtles}\label{md_vendor_googletest_googlemock_docs_v1_6__for_dummies_autotoc_md449}
...
Admittedly, this test is contrived and doesn\textquotesingle{}t do much. You can easily achieve the same effect without using Google \mbox{\hyperlink{class_mock}{Mock}}. However, as we shall reveal soon, Google \mbox{\hyperlink{class_mock}{Mock}} allows you to do {\itshape much more} with the mocks.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__for_dummies_autotoc_md454}{}\doxysubsection{Using Google Mock with Any Testing Framework}\label{md_vendor_googletest_googlemock_docs_v1_6__for_dummies_autotoc_md454}
...
If this turns out to be too much work, we suggest that you stick with Google Test, which works with Google \mbox{\hyperlink{class_mock}{Mock}} seamlessly (in fact, it is technically part of Google \mbox{\hyperlink{class_mock}{Mock}}.). If there is a reason that you cannot use Google Test, please let us know.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__for_dummies_autotoc_md455}{}\doxysection{Setting Expectations}\label{md_vendor_googletest_googlemock_docs_v1_6__for_dummies_autotoc_md455}
The key to using a mock object successfully is to set the {\itshape right expectations} on it. If you set the expectations too strict, your test will fail as the result of unrelated changes. If you set them too loose, bugs can slip through. You want to do it just right such that your test can catch exactly the kind of bugs you intend it to catch. Google \mbox{\hyperlink{class_mock}{Mock}} provides the necessary means for you to do it \char`\"{}just right.\char`\"{}\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__for_dummies_autotoc_md456}{}\doxysubsection{General Syntax}\label{md_vendor_googletest_googlemock_docs_v1_6__for_dummies_autotoc_md456}
...
This checks that the turtle will be told to go forward by at least 100 units.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__for_dummies_autotoc_md458}{}\doxysubsection{Cardinalities\+: How Many Times Will It Be Called?}\label{md_vendor_googletest_googlemock_docs_v1_6__for_dummies_autotoc_md458}
...
What can we do inside {\ttfamily Will\+Once()} besides {\ttfamily Return()}? You can return a reference using {\ttfamily Return\+Ref(variable)}, or invoke a pre-\/defined function, among \href{http://code.google.com/p/googlemock/wiki/V1_6_CheatSheet\#Actions}{\texttt{ others}}.
...
(What if you care about the relative order of some of the calls, but not all of them? Can you specify an arbitrary partial order? The answer is ... yes! If you are impatient, the details can be found in the Cook\+Book.)\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__for_dummies_autotoc_md462}{}\doxysubsection{All Expectations Are Sticky (\+Unless Said Otherwise)}\label{md_vendor_googletest_googlemock_docs_v1_6__for_dummies_autotoc_md462}
