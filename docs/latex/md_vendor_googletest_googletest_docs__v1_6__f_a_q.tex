If you cannot find the answer to your question here, and you have read Primer and Advanced\+Guide, send it to \href{mailto:googletestframework@googlegroups.com}{\texttt{ googletestframework@googlegroups.\+com}}.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1004}{}\doxysubsection{Why should I use Google Test instead of my favorite C++ testing framework?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1004}
...
\end{DoxyItemize}
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1005}{}\doxysubsection{I\textquotesingle{}m getting warnings when compiling Google Test.  Would you fix them?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1005}
...
If you see warnings when compiling Google Test, we suggest that you use the {\ttfamily -\/isystem} flag (assuming your are using G\+CC) to mark Google Test headers as system headers. That\textquotesingle{}ll suppress warnings from Google Test headers.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1006}{}\doxysubsection{Why should not test case names and test names contain underscore?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1006}
...
If you violate the rule, there may not be immediately consequences, but your test may (just may) break with a new compiler (or a new version of the compiler you are using) or with a new version of Google Test. Therefore it\textquotesingle{}s best to follow the rule.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1007}{}\doxysubsection{Why is it not recommended to install a pre-\/compiled copy of Google Test (for example, into /usr/local)?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1007}
...
In order to prevent build output files from overwriting one another, you\textquotesingle{}ll need to change the {\ttfamily Intermediate Directory} settings for the newly created platform configuration across all the projects. To do this, multi-\/select (e.\+g. using shift-\/click) all projects (but not the solution) in the {\ttfamily Solution Explorer}. Right-\/click one of them and select {\ttfamily Properties}. In the left pane, select {\ttfamily Configuration Properties}, and from the {\ttfamily Configuration} dropdown, select {\ttfamily All Configurations}. Make sure the selected platform is {\ttfamily x64}. For the {\ttfamily Intermediate Directory} setting, change the value from {\ttfamily \textbackslash{}} to {\ttfamily \textbackslash{}}. Click {\ttfamily OK} and then build the solution. When the build is complete, the 64-\/bit binaries will be in the {\ttfamily msvc\textbackslash{}x64\textbackslash{}Debug} directory.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1009}{}\doxysubsection{Can I use Google Test on Min\+G\+W?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1009}
...
Please contact {\ttfamily googletestframework@googlegroups.\+com} if you are interested in improving the support for Min\+GW.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1010}{}\doxysubsection{Why does Google Test support E\+X\+P\+E\+C\+T\+\_\+\+E\+Q(\+N\+U\+L\+L, ptr) and A\+S\+S\+E\+R\+T\+\_\+\+E\+Q(\+N\+U\+L\+L, ptr) but not E\+X\+P\+E\+C\+T\+\_\+\+N\+E(\+N\+U\+L\+L, ptr) and A\+S\+S\+E\+R\+T\+\_\+\+N\+E(\+N\+U\+L\+L, ptr)?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1010}
...
Finally, with the growth of Google \mbox{\hyperlink{class_mock}{Mock}}\textquotesingle{}s \href{../../CookBook.md\#using-matchers-in-google-test-assertions}{\texttt{ matcher}} library, we are encouraging people to use the unified {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+T\+H\+A\+T(value, matcher)} syntax more often in tests. One significant advantage of the matcher approach is that matchers can be easily combined to form new matchers, while the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+NE}, etc, macros cannot be easily combined. Therefore we want to invest more in the matchers than in the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+X\+X()} macros.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1011}{}\doxysubsection{Does Google Test support running tests in parallel?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1011}
Test runners tend to be tightly coupled with the build/test environment, and Google Test doesn\textquotesingle{}t try to solve the problem of running tests in parallel. Instead, we tried to make Google Test work nicely with test runners. For example, Google Test\textquotesingle{}s X\+ML report contains the time spent on each test, and its {\ttfamily gtest\+\_\+list\+\_\+tests} and {\ttfamily gtest\+\_\+filter} flags can be used for splitting the execution of test methods into multiple processes. These functionalities can help the test runner run the tests in parallel.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1012}{}\doxysubsection{Why don\textquotesingle{}t Google Test run the tests in different threads to speed things up?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1012}
...
If you think about it, it\textquotesingle{}s already hard to make your code work when you know what other threads are doing. It\textquotesingle{}s much harder, and sometimes even impossible, to make your code work when you don\textquotesingle{}t know what other threads are doing (remember that test methods can be added, deleted, or modified after your test was written). If you want to run the tests in parallel, you\textquotesingle{}d better run them in different processes.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1013}{}\doxysubsection{Why aren\textquotesingle{}t Google Test assertions implemented using exceptions?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1013}
...
The downside of not using exceptions is that {\ttfamily A\+S\+S\+E\+R\+T\+\_\+$\ast$} (implemented using {\ttfamily return}) will only abort the current function, not the current {\ttfamily T\+E\+ST}.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1014}{}\doxysubsection{Why do we use two different macros for tests with and without fixtures?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1014}
...
We think neither approach is ideal, yet either of them is reasonable. In the end, it probably doesn\textquotesingle{}t matter much either way.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1015}{}\doxysubsection{Why don\textquotesingle{}t we use structs as test fixtures?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1015}
We like to use structs only when representing passive data. This distinction between structs and classes is good for documenting the intent of the code\textquotesingle{}s author. Since test fixtures have logic like {\ttfamily Set\+Up()} and {\ttfamily Tear\+Down()}, they are better defined as classes.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1016}{}\doxysubsection{Why are death tests implemented as assertions instead of using a test runner?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1016}
...
Otherwise your code is {\bfseries{invalid C++}}, and may break in unexpected ways. In particular, using it in Google Test comparison assertions ({\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+EQ}, etc) will generate an \char`\"{}undefined reference\char`\"{} linker error.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1019}{}\doxysubsection{I have an interface that has several implementations. Can I write a set of tests once and repeat them over all the implementations?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1019}
Google Test doesn\textquotesingle{}t yet have good support for this kind of tests, or data-\/driven tests in general. We hope to be able to make improvements in this area soon.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1020}{}\doxysubsection{Can I derive a test fixture from another?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1020}
Yes.
...
For a complete example using derived test fixtures, see \href{../samples/sample5_unittest.cc}{\texttt{ sample5}}.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1021}{}\doxysubsection{My compiler complains \char`\"{}void value not ignored as it ought to be.\char`\"{} What does this mean?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1021}
You\textquotesingle{}re probably using an {\ttfamily A\+S\+S\+E\+R\+T\+\_\+$\ast$()} in a function that doesn\textquotesingle{}t return {\ttfamily void}. {\ttfamily A\+S\+S\+E\+R\+T\+\_\+$\ast$()} can only be used in {\ttfamily void} functions.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1022}{}\doxysubsection{My death test hangs (or seg-\/faults). How do I fix it?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1022}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1024}{}\doxysubsection{The compiler complains \char`\"{}no matching function to call\char`\"{} when I use A\+S\+S\+E\+R\+T\+\_\+\+P\+R\+E\+Dn. How do I fix it?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1024}
...
\DoxyCodeLine{ASSERT\_PRED2(*(GreaterThan<int, int>)*, 5, 0);}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1025}{}\doxysubsection{My compiler complains about \char`\"{}ignoring return value\char`\"{} when I call R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S(). Why?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1025}
...
To help the users avoid this dangerous bug, the implementation of {\ttfamily R\+U\+N\+\_\+\+A\+L\+L\+\_\+\+T\+E\+S\+T\+S()} causes gcc to raise this warning, when the return value is ignored. If you see this warning, the fix is simple\+: just make sure its value is used as the return value of {\ttfamily main()}.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1026}{}\doxysubsection{My compiler complains that a constructor (or destructor) cannot return a value. What\textquotesingle{}s going on?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1026}
...
we had to give up using {\ttfamily A\+S\+S\+E\+R\+T$\ast$} and {\ttfamily F\+A\+I\+L$\ast$} (but not {\ttfamily E\+X\+P\+E\+C\+T$\ast$} and {\ttfamily A\+D\+D\+\_\+\+F\+A\+I\+L\+U\+R\+E$\ast$}) in constructors and destructors. The workaround is to move the content of your constructor/destructor to a private void member function, or switch to {\ttfamily E\+X\+P\+E\+C\+T\+\_\+$\ast$()} if that works. This section in the user\textquotesingle{}s guide explains it.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1027}{}\doxysubsection{My set-\/up function is not called. Why?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1027}
C++ is case-\/sensitive. It should be spelled as {\ttfamily Set\+Up()}. Did you spell it as {\ttfamily Setup()}?

Similarly, sometimes people spell {\ttfamily Set\+Up\+Test\+Case()} as {\ttfamily Setup\+Test\+Case()} and wonder why it\textquotesingle{}s never called.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1028}{}\doxysubsection{How do I jump to the line of a failure in Emacs directly?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1028}
Google Test\textquotesingle{}s failure message format is understood by Emacs and many other I\+D\+Es, like acme and X\+Code. If a Google Test message is in a compilation buffer in Emacs, then it\textquotesingle{}s clickable. You can now hit {\ttfamily enter} on a message to jump to the corresponding source code, or use {\ttfamily C-\/x}\`{} to jump to the next failure.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1029}{}\doxysubsection{I have several test cases which share the same test fixture logic, do I have to define a new test fixture class for each of them? This seems pretty tedious.}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1029}
...
\DoxyCodeLine{TEST\_F(BarTest, Def) \{ ... \}}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1030}{}\doxysubsection{The Google Test output is buried in a whole bunch of log messages. What do I do?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1030}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1031}{}\doxysubsection{Why should I prefer test fixtures over global variables?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1031}
...
\end{DoxyEnumerate}\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1032}{}\doxysubsection{How do I test private class members without writing F\+R\+I\+E\+N\+D\+\_\+\+T\+E\+S\+T()s?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1032}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1033}{}\doxysubsection{How do I test private class static members without writing F\+R\+I\+E\+N\+D\+\_\+\+T\+E\+S\+T()s?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1033}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1034}{}\doxysubsection{I would like to run a test several times with different parameters. Do I need to write several similar copies of it?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1034}
No. You can use a feature called \href{V1_6_AdvancedGuide.md\#Value_Parameterized_Tests}{\texttt{ value-\/parameterized tests}} which lets you repeat your tests with different parameters, without defining it more than once.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1035}{}\doxysubsection{How do I test a file that defines main()?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1035}
...
However, please remember this is a hack and should only be used as the last resort.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1036}{}\doxysubsection{What can the statement argument in A\+S\+S\+E\+R\+T\+\_\+\+D\+E\+A\+T\+H() be?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1036}
...
{\ttfamily googletest\+\_\+unittest.\+cc} contains more examples if you are interested.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1037}{}\doxysubsection{What syntax does the regular expression in A\+S\+S\+E\+R\+T\+\_\+\+D\+E\+A\+T\+H use?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1037}
On P\+O\+S\+IX systems, Google Test uses the P\+O\+S\+IX Extended regular expression syntax (\href{http://en.wikipedia.org/wiki/Regular_expression\#POSIX_Extended_Regular_Expressions}{\texttt{ http\+://en.\+wikipedia.\+org/wiki/\+Regular\+\_\+expression\#\+P\+O\+S\+I\+X\+\_\+\+Extended\+\_\+\+Regular\+\_\+\+Expressions}}). On Windows, it uses a limited variant of regular expression syntax. For more details, see the \href{V1_6_AdvancedGuide.md\#Regular_Expression_Syntax}{\texttt{ regular expression syntax}}.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1038}{}\doxysubsection{I have a fixture class Foo, but T\+E\+S\+T\+\_\+\+F(\+Foo, Bar) gives me error \char`\"{}no matching function for call to Foo\+::\+Foo()\char`\"{}. Why?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1038}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1039}{}\doxysubsection{Why does A\+S\+S\+E\+R\+T\+\_\+\+D\+E\+A\+T\+H complain about previous threads that were already joined?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1039}
...
The new N\+P\+TL thread library doesn\textquotesingle{}t suffer from this problem, as it doesn\textquotesingle{}t create a manager thread. However, if you don\textquotesingle{}t control which machine your test runs on, you shouldn\textquotesingle{}t depend on this.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1040}{}\doxysubsection{Why does Google Test require the entire test case, instead of individual tests, to be named F\+O\+O\+Death\+Test when it uses A\+S\+S\+E\+R\+T\+\_\+\+D\+E\+A\+T\+H?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1040}
...
Since {\ttfamily Foo\+Test.\+Abc\+Death\+Test} needs to run before {\ttfamily Bar\+Test.\+Xyz}, and we don\textquotesingle{}t interleave tests from different test cases, we need to run all tests in the {\ttfamily \mbox{\hyperlink{class_foo_test}{Foo\+Test}}} case before running any test in the {\ttfamily Bar\+Test} case. This contradicts with the requirement to run {\ttfamily Bar\+Test.\+Def\+Death\+Test} before {\ttfamily Foo\+Test.\+Uvw}.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1041}{}\doxysubsection{But I don\textquotesingle{}t like calling my entire test case F\+O\+O\+Death\+Test when it contains both death tests and non-\/death tests. What do I do?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1041}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1042}{}\doxysubsection{The compiler complains about \char`\"{}no match for \textquotesingle{}operator$<$$<$\textquotesingle{}\char`\"{} when I use an assertion. What gives?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1042}
...
To update this setting open the project properties in the Visual Studio I\+DE then select the branch Configuration Properties $\vert$ C/\+C++ $\vert$ Code Generation and change the option \char`\"{}\+Runtime Library\char`\"{}. You may also try using gtest-\/md.\+vcproj instead of gtest.\+vcproj.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1045}{}\doxysubsection{I put my tests in a library and Google Test doesn\textquotesingle{}t run them. What\textquotesingle{}s happening?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1045}
Have you read a \href{V1_6_Primer.md\#important-note-for-visual-c-users}{\texttt{ warning}} on the Google Test Primer page?\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1046}{}\doxysubsection{I want to use Google Test with Visual Studio but don\textquotesingle{}t know where to start.}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1046}
Many people are in your position and one of the posted his solution to our mailing list. Here is his link\+: \href{http://hassanjamilahmad.blogspot.com/2009/07/gtest-starters-help.html}{\texttt{ http\+://hassanjamilahmad.\+blogspot.\+com/2009/07/gtest-\/starters-\/help.\+html}}.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1047}{}\doxysubsection{I am seeing compile errors mentioning std\+::type\+\_\+traits when I try to use Google Test on Solaris.}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1047}
...
`export CC=cc C\+XX=CC C\+X\+X\+F\+L\+A\+GS='-\/library=stlport4\textquotesingle{}\`{}\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1048}{}\doxysubsection{How can my code detect if it is running in a test?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1048}
...
However, if you {\itshape really}, {\itshape really}, {\itshape really} have no choice, and if you follow the rule of ending your test program names with {\ttfamily \+\_\+test}, you can use the {\itshape horrible} hack of sniffing your executable name ({\ttfamily argv\mbox{[}0\mbox{]}} in {\ttfamily main()}) to know whether the code is under test.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1049}{}\doxysubsection{Google Test defines a macro that clashes with one defined by another library. How do I deal with that?}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1049}
...
Currently, the following {\ttfamily T\+E\+ST}, {\ttfamily F\+A\+IL}, {\ttfamily S\+U\+C\+C\+E\+ED}, and the basic comparison assertion macros can have alternative names. You can see the full list of covered macros \href{http://www.google.com/codesearch?q=if+!GTEST_DONT_DEFINE_\\w\%2B+package:http://googletest\\.googlecode\\.com+file:/include/gtest/gtest.h}{\texttt{ here}}. More information can be found in the \char`\"{}\+Avoiding Macro Name Clashes\char`\"{} section of the R\+E\+A\+D\+ME file.\hypertarget{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1050}{}\doxysubsection{My question is not covered in your F\+A\+Q!}\label{md_vendor_googletest_googletest_docs__v1_6__f_a_q_autotoc_md1050}
