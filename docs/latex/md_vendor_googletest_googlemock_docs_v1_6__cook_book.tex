...
{\bfseries{Note\+:}} Google \mbox{\hyperlink{class_mock}{Mock}} lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using \+::testing\+::\+Foo;} once in your file before using the name {\ttfamily Foo} defined by Google \mbox{\hyperlink{class_mock}{Mock}}. We omit such {\ttfamily using} statements in this page for brevity, but you should do it in your own code.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md373}{}\doxysection{Creating Mock Classes}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md373}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md374}{}\doxysubsection{Mocking Private or Protected Methods}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md374}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md375}{}\doxysubsection{Mocking Overloaded Methods}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md375}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md376}{}\doxysubsection{Mocking Class Templates}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md376}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md377}{}\doxysubsection{Mocking Nonvirtual Methods}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md377}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md378}{}\doxysubsection{Mocking Free Functions}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md378}
...
By defining a new mock method with a trimmed argument list, we make the mock class much more user-\/friendly.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md381}{}\doxysubsection{Alternative to Mocking Concrete Classes}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md381}
...
You need to weigh the pros and cons carefully for your particular problem, but I\textquotesingle{}d like to assure you that the Java community has been practicing this for a long time and it\textquotesingle{}s a proven effective technique applicable in a wide variety of situations. \+:-\/)\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md382}{}\doxysubsection{Delegating Calls to a Fake}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md382}
...
Instead, you can define a {\ttfamily File\+Ops} interface and an {\ttfamily I\+O\+Ops} interface and split {\ttfamily System}\textquotesingle{}s functionalities into the two. Then you can mock {\ttfamily I\+O\+Ops} without mocking {\ttfamily File\+Ops}.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md383}{}\doxysubsection{Delegating Calls to a Real Object}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md383}
...
(Why don\textquotesingle{}t we just write {\ttfamily Invoke(\&foo, \&\+Foo\+::\+Concrete)}? If you do that, {\ttfamily Mock\+Foo\+::\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo\+::\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md385}{}\doxysection{Using Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md385}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md386}{}\doxysubsection{Matching Argument Values Exactly}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md386}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md387}{}\doxysubsection{Using Simple Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md387}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md388}{}\doxysubsection{Combining Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md388}
...
\DoxyCodeLine{                          NULL));}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md389}{}\doxysubsection{Casting Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md389}
...
{\ttfamily Matcher\+Cast} essentially lets you bypass C++\textquotesingle{}s type system ({\ttfamily static\+\_\+cast} isn\textquotesingle{}t always safe as it could throw away information, for example), so be careful not to misuse/abuse it.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md390}{}\doxysubsection{Selecting Between Overloaded Functions}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md390}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md391}{}\doxysubsection{Performing Different Actions Based on the Arguments}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md391}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md392}{}\doxysubsection{Matching Multiple Arguments as a Whole}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md392}
...
Note that if you want to pass the arguments to a predicate of your own (e.\+g. {\ttfamily .With(Args$<$0, 1$>$(Truly(\&\+My\+Predicate)))}), that predicate M\+U\+ST be written to take a {\ttfamily tr1\+::tuple} as its argument; Google \mbox{\hyperlink{class_mock}{Mock}} will pass the {\ttfamily n} selected arguments as {\itshape one} single tuple to the predicate.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md393}{}\doxysubsection{Using Matchers as Predicates}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md393}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md394}{}\doxysubsection{Using Matchers in Google Test Assertions}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md394}
...
{\bfseries{Credit\+:}} The idea of {\ttfamily (A\+S\+S\+E\+R\+T$\vert$\+E\+X\+P\+E\+CT)\+\_\+\+T\+H\+AT} was stolen from the \href{http://code.google.com/p/hamcrest/}{\texttt{ Hamcrest}} project, which adds {\ttfamily assert\+That()} to J\+Unit.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md395}{}\doxysubsection{Using Predicates as Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md395}
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in statement {\ttfamily if (condition) ...}.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md396}{}\doxysubsection{Matching Arguments that Are Not Copyable}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md396}
...
Remember\+: if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}, or the result is undefined.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md397}{}\doxysubsection{Validating a Member of an Object}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md397}
...
What if you want to validate more than one members at the same time? Remember that there is {\ttfamily All\+Of()}.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md398}{}\doxysubsection{Validating the Value Pointed to by a Pointer Argument}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md398}
...
What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily Pointee()} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md399}{}\doxysubsection{Testing a Certain Property of an Object}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md399}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md400}{}\doxysubsection{Matching Containers}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md400}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md401}{}\doxysubsection{Sharing Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md401}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md402}{}\doxysection{Setting Expectations}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md402}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md403}{}\doxysubsection{Ignoring Uninteresting Calls}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md403}
...
Please note that once you expressed interest in a particular mock method (via {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}), all invocations to it must match some expectation. If this function is called but the arguments don\textquotesingle{}t match any {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} statement, it will be an error.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md404}{}\doxysubsection{Disallowing Unexpected Calls}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md404}
...
A call to {\ttfamily foo.\+Bar()} that doesn\textquotesingle{}t match any of the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} statements will be an error.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md405}{}\doxysubsection{Expecting Ordered Calls}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md405}
...
In this example, we expect a call to {\ttfamily foo.\+Do\+This(5)}, followed by two calls to {\ttfamily bar.\+Do\+That()} where the argument can be anything, which are in turn followed by a call to {\ttfamily foo.\+Do\+This(6)}. If a call occurred out-\/of-\/order, Google \mbox{\hyperlink{class_mock}{Mock}} will report an error.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md406}{}\doxysubsection{Expecting Partially Ordered Calls}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md406}
...
This means that A must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md407}{}\doxysubsection{Controlling When an Expectation Retires}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md407}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily \char`\"{}\+File too large.\char`\"{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md408}{}\doxysection{Using Actions}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md408}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md409}{}\doxysubsection{Returning References from Mock Methods}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md409}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md410}{}\doxysubsection{Returning Live Values from Mock Methods}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md410}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md411}{}\doxysubsection{Combining Actions}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md411}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md412}{}\doxysubsection{Mocking Side Effects}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md412}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md413}{}\doxysubsection{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md413}
...
Here {\ttfamily my\+\_\+mock.\+Get\+Prev\+Value()} will always return the argument of the last {\ttfamily Update\+Value()} call.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md414}{}\doxysubsection{Setting the Default Value for a Return Type}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md414}
...
Please note that changing the default value for a type can make you tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md415}{}\doxysubsection{Setting the Default Actions for a Mock Method}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md415}
...
The only requirement is that the type of the function, etc must be {\itshape compatible} with the signature of the mock function, meaning that the latter\textquotesingle{}s arguments can be implicitly converted to the corresponding arguments of the former, and the former\textquotesingle{}s return type can be implicitly converted to that of the latter. So, you can invoke something whose type is {\itshape not} exactly the same as the mock function, as long as it\textquotesingle{}s safe to do so -\/ nice, huh?\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md417}{}\doxysubsection{Invoking a Function/\+Method/\+Functor Without Arguments}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md417}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md418}{}\doxysubsection{Invoking an Argument of the Mock Function}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md418}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md419}{}\doxysubsection{Ignoring an Action\textquotesingle{}s Result}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md419}
...
Note that you {\bfseries{cannot}} use {\ttfamily Ignore\+Result()} on an action that already returns {\ttfamily void}. Doing so will lead to ugly compiler errors.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md420}{}\doxysubsection{Selecting an Action\textquotesingle{}s Arguments}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md420}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md421}{}\doxysubsection{Ignoring Arguments in Action Functions}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md421}
...
\DoxyCodeLine{      .WillOnce(Invoke(DistanceToOrigin));}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md422}{}\doxysubsection{Sharing Actions}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md422}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md423}{}\doxysection{Misc Recipes on Using Google Mock}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md423}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md424}{}\doxysubsection{Making the Compilation Faster}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md424}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md425}{}\doxysubsection{Forcing a Verification}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md425}
...
{\bfseries{Tip\+:}} The {\ttfamily Mock\+::\+Verify\+And\+Clear\+Expectations()} function returns a {\ttfamily bool} to indicate whether the verification was successful ({\ttfamily true} for yes), so you can wrap that function call inside a {\ttfamily A\+S\+S\+E\+R\+T\+\_\+\+T\+R\+U\+E()} if there is no point going further when the verification has failed.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md426}{}\doxysubsection{Using Check Points}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md426}
...
And that\textquotesingle{}s that.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md428}{}\doxysubsection{Using Google Mock and Threads}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md428}
...
Also, remember that {\ttfamily Default\+Value$<$T$>$} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md429}{}\doxysubsection{Controlling How Much Information Google Mock Prints}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md429}
...
Now, judiciously use the right flag to enable Google \mbox{\hyperlink{class_mock}{Mock}} serve you better!\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md430}{}\doxysubsection{Running Tests in Emacs}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md430}
...
Then you can type {\ttfamily M-\/m} to start a build, or {\ttfamily M-\/up}/{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md431}{}\doxysubsection{Fusing Google Mock Source Files}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md431}
...
\end{DoxyEnumerate}\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md434}{}\doxysubsection{Writing New Parameterized Matchers Quickly}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md434}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md436}{}\doxysubsection{Writing New Polymorphic Matchers}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md436}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md437}{}\doxysubsection{Writing New Cardinalities}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md437}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md438}{}\doxysubsection{Writing New Actions Quickly}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md438}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md439}{}\doxysubsection{Writing New Parameterized Actions Quickly}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md439}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md440}{}\doxysubsection{Restricting the Type of an Argument or Parameter in an A\+C\+T\+I\+ON}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md440}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in Google Test that verifies two types are the same.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md441}{}\doxysubsection{Writing New Action Templates Quickly}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md441}
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md442}{}\doxysubsection{Using the A\+C\+T\+I\+O\+N Object\textquotesingle{}s Type}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md442}
...
Note that we have to pick different suffixes ({\ttfamily Action}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of value parameters, or the action definitions cannot be overloaded on the number of them.\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md443}{}\doxysubsection{Writing New Monomorphic Actions}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md443}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md444}{}\doxysubsection{Writing New Polymorphic Actions}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md444}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md445}{}\doxysubsection{Teaching Google Mock How to Print Your Values}\label{md_vendor_googletest_googlemock_docs_v1_6__cook_book_autotoc_md445}
