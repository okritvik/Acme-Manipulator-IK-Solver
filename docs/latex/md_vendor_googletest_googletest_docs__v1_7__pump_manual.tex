{\bfseries{P}}ump is {\bfseries{U}}seful for {\bfseries{M}}eta {\bfseries{P}}rogramming.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__pump_manual_autotoc_md1206}{}\doxysection{The Problem}\label{md_vendor_googletest_googletest_docs__v1_7__pump_manual_autotoc_md1206}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googletest_docs__v1_7__pump_manual_autotoc_md1209}{}\doxysubsection{Examples}\label{md_vendor_googletest_googletest_docs__v1_7__pump_manual_autotoc_md1209}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_7__pump_manual_autotoc_md1210}{}\doxysubsection{Constructs}\label{md_vendor_googletest_googletest_docs__v1_7__pump_manual_autotoc_md1210}
...
{\bfseries{Note\+:}} To give the user some freedom in formatting the Pump source code, Pump ignores a new-\/line character if it\textquotesingle{}s right after {\ttfamily \$for foo} or next to {\ttfamily \mbox{[}\mbox{[}} or {\ttfamily \mbox{]}\mbox{]}}. Without this rule you\textquotesingle{}ll often be forced to write very long lines to get the desired output. Therefore sometimes you may need to insert an extra new-\/line in such places for a new-\/line to show up in your output.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__pump_manual_autotoc_md1211}{}\doxysubsection{Grammar}\label{md_vendor_googletest_googletest_docs__v1_7__pump_manual_autotoc_md1211}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googletest_docs__v1_7__pump_manual_autotoc_md1212}{}\doxysubsection{Code}\label{md_vendor_googletest_googletest_docs__v1_7__pump_manual_autotoc_md1212}
You can find the source code of Pump in \href{../scripts/pump.py}{\texttt{ scripts/pump.\+py}}. It is still very unpolished and lacks automated tests, although it has been successfully used many times. If you find a chance to use it in your project, please let us know what you think! We also welcome help on improving Pump.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__pump_manual_autotoc_md1213}{}\doxysubsection{Real Examples}\label{md_vendor_googletest_googletest_docs__v1_7__pump_manual_autotoc_md1213}
You can find real-\/world applications of Pump in \href{http://www.google.com/codesearch?q=file\%3A\\.pump\%24+package\%3Ahttp\%3A\%2F\%2Fgoogletest\\.googlecode\\.com}{\texttt{ Google Test}} and \href{http://www.google.com/codesearch?q=file\%3A\\.pump\%24+package\%3Ahttp\%3A\%2F\%2Fgooglemock\\.googlecode\\.com}{\texttt{ Google Mock}}. The source file {\ttfamily foo.\+h.\+pump} generates {\ttfamily foo.\+h}.\hypertarget{md_vendor_googletest_googletest_docs__v1_7__pump_manual_autotoc_md1214}{}\doxysubsection{Tips}\label{md_vendor_googletest_googletest_docs__v1_7__pump_manual_autotoc_md1214}
