...
{\bfseries{Note\+:}} Google \mbox{\hyperlink{class_mock}{Mock}} lives in the {\ttfamily testing} name space. For readability, it is recommended to write {\ttfamily using \+::testing\+::\+Foo;} once in your file before using the name {\ttfamily Foo} defined by Google \mbox{\hyperlink{class_mock}{Mock}}. We omit such {\ttfamily using} statements in this page for brevity, but you should do it in your own code.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md43}{}\doxysection{Creating Mock Classes}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md43}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md44}{}\doxysubsection{Mocking Private or Protected Methods}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md44}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md45}{}\doxysubsection{Mocking Overloaded Methods}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md45}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md46}{}\doxysubsection{Mocking Class Templates}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md46}
...
\DoxyCodeLine{\};}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md47}{}\doxysubsection{Mocking Nonvirtual Methods}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md47}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md48}{}\doxysubsection{Mocking Free Functions}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md48}
...
By defining a new mock method with a trimmed argument list, we make the mock class much more user-\/friendly.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md51}{}\doxysubsection{Alternative to Mocking Concrete Classes}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md51}
...
You need to weigh the pros and cons carefully for your particular problem, but I\textquotesingle{}d like to assure you that the Java community has been practicing this for a long time and it\textquotesingle{}s a proven effective technique applicable in a wide variety of situations. \+:-\/)\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md52}{}\doxysubsection{Delegating Calls to a Fake}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md52}
...
(Why don\textquotesingle{}t we just write {\ttfamily Invoke(\&foo, \&\+Foo\+::\+Concrete)}? If you do that, {\ttfamily Mock\+Foo\+::\+Concrete()} will be called (and cause an infinite recursion) since {\ttfamily Foo\+::\+Concrete()} is virtual. That\textquotesingle{}s just how C++ works.)\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md55}{}\doxysection{Using Matchers}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md55}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md56}{}\doxysubsection{Matching Argument Values Exactly}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md56}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md57}{}\doxysubsection{Using Simple Matchers}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md57}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md58}{}\doxysubsection{Combining Matchers}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md58}
...
\DoxyCodeLine{                          NULL));}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md59}{}\doxysubsection{Casting Matchers}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md59}
...
{\ttfamily Matcher\+Cast} essentially lets you bypass C++\textquotesingle{}s type system ({\ttfamily static\+\_\+cast} isn\textquotesingle{}t always safe as it could throw away information, for example), so be careful not to misuse/abuse it.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md60}{}\doxysubsection{Selecting Between Overloaded Functions}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md60}
...
\DoxyCodeLine{\}}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md61}{}\doxysubsection{Performing Different Actions Based on the Arguments}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md61}
...
Now, if {\ttfamily foo.\+Do\+This()} is called with a value less than 5, `\textquotesingle{}a'{\ttfamily will be returned; otherwise}\textquotesingle{}b\textquotesingle{}\`{} will be returned.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md62}{}\doxysubsection{Matching Multiple Arguments as a Whole}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md62}
...
Note that if you want to pass the arguments to a predicate of your own (e.\+g. {\ttfamily .With(Args$<$0, 1$>$(Truly(\&\+My\+Predicate)))}), that predicate M\+U\+ST be written to take a {\ttfamily \+::testing\+::tuple} as its argument; Google \mbox{\hyperlink{class_mock}{Mock}} will pass the {\ttfamily n} selected arguments as {\itshape one} single tuple to the predicate.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md63}{}\doxysubsection{Using Matchers as Predicates}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md63}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md64}{}\doxysubsection{Using Matchers in Google Test Assertions}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md64}
...
{\bfseries{Credit\+:}} The idea of {\ttfamily (A\+S\+S\+E\+R\+T$\vert$\+E\+X\+P\+E\+CT)\+\_\+\+T\+H\+AT} was stolen from the \href{https://github.com/hamcrest/}{\texttt{ Hamcrest}} project, which adds {\ttfamily assert\+That()} to J\+Unit.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md65}{}\doxysubsection{Using Predicates as Matchers}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md65}
...
Note that the predicate function / functor doesn\textquotesingle{}t have to return {\ttfamily bool}. It works as long as the return value can be used as the condition in statement {\ttfamily if (condition) ...}.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md66}{}\doxysubsection{Matching Arguments that Are Not Copyable}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md66}
...
Remember\+: if you do this, don\textquotesingle{}t change {\ttfamily bar} after the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}, or the result is undefined.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md67}{}\doxysubsection{Validating a Member of an Object}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md67}
...
What if you want to validate more than one members at the same time? Remember that there is {\ttfamily All\+Of()}.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md68}{}\doxysubsection{Validating the Value Pointed to by a Pointer Argument}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md68}
...
What if you have a pointer to pointer? You guessed it -\/ you can use nested {\ttfamily Pointee()} to probe deeper inside the value. For example, {\ttfamily Pointee(Pointee(\+Lt(3)))} matches a pointer that points to a pointer that points to a number less than 3 (what a mouthful...).\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md69}{}\doxysubsection{Testing a Certain Property of an Object}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md69}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md70}{}\doxysubsection{Matching Containers}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md70}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md71}{}\doxysubsection{Sharing Matchers}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md71}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md72}{}\doxysection{Setting Expectations}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md72}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md73}{}\doxysubsection{Knowing When to Expect}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md73}
...
Please note that once you expressed interest in a particular mock method (via {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}), all invocations to it must match some expectation. If this function is called but the arguments don\textquotesingle{}t match any {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} statement, it will be an error.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md75}{}\doxysubsection{Disallowing Unexpected Calls}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md75}
...
A call to {\ttfamily foo.\+Bar()} that doesn\textquotesingle{}t match any of the {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()} statements will be an error.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md76}{}\doxysubsection{Understanding Uninteresting vs Unexpected Calls}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md76}
...
For more on uninteresting calls, nice mocks, and strict mocks, read \href{\#the-nice-the-strict-and-the-naggy}{\texttt{ \char`\"{}\+The Nice, the Strict, and the Naggy\char`\"{}}}.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md77}{}\doxysubsection{Expecting Ordered Calls}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md77}
...
In this example, we expect a call to {\ttfamily foo.\+Do\+This(5)}, followed by two calls to {\ttfamily bar.\+Do\+That()} where the argument can be anything, which are in turn followed by a call to {\ttfamily foo.\+Do\+This(6)}. If a call occurred out-\/of-\/order, Google \mbox{\hyperlink{class_mock}{Mock}} will report an error.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md78}{}\doxysubsection{Expecting Partially Ordered Calls}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md78}
...
This means that A must occur before B and C, and C must occur before D. There\textquotesingle{}s no restriction about the order other than these.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md79}{}\doxysubsection{Controlling When an Expectation Retires}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md79}
...
Here \#2 can be used only once, so if you have two warnings with the message {\ttfamily \char`\"{}\+File too large.\char`\"{}}, the first will match \#2 and the second will match \#1 -\/ there will be no error.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md80}{}\doxysection{Using Actions}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md80}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md81}{}\doxysubsection{Returning References from Mock Methods}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md81}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md82}{}\doxysubsection{Returning Live Values from Mock Methods}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md82}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md83}{}\doxysubsection{Combining Actions}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md83}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md84}{}\doxysubsection{Mocking Side Effects}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md84}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md85}{}\doxysubsection{Changing a Mock Object\textquotesingle{}s Behavior Based on the State}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md85}
...
Here {\ttfamily my\+\_\+mock.\+Get\+Prev\+Value()} will always return the argument of the last {\ttfamily Update\+Value()} call.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md86}{}\doxysubsection{Setting the Default Value for a Return Type}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md86}
...
Please note that changing the default value for a type can make you tests hard to understand. We recommend you to use this feature judiciously. For example, you may want to make sure the {\ttfamily Set()} and {\ttfamily Clear()} calls are right next to the code that uses your mock.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md87}{}\doxysubsection{Setting the Default Actions for a Mock Method}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md87}
...
The only requirement is that the type of the function, etc must be {\itshape compatible} with the signature of the mock function, meaning that the latter\textquotesingle{}s arguments can be implicitly converted to the corresponding arguments of the former, and the former\textquotesingle{}s return type can be implicitly converted to that of the latter. So, you can invoke something whose type is {\itshape not} exactly the same as the mock function, as long as it\textquotesingle{}s safe to do so -\/ nice, huh?\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md89}{}\doxysubsection{Invoking a Function/\+Method/\+Functor Without Arguments}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md89}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md90}{}\doxysubsection{Invoking an Argument of the Mock Function}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md90}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md91}{}\doxysubsection{Ignoring an Action\textquotesingle{}s Result}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md91}
...
Note that you {\bfseries{cannot}} use {\ttfamily Ignore\+Result()} on an action that already returns {\ttfamily void}. Doing so will lead to ugly compiler errors.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md92}{}\doxysubsection{Selecting an Action\textquotesingle{}s Arguments}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md92}
...
\end{DoxyItemize}\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md93}{}\doxysubsection{Ignoring Arguments in Action Functions}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md93}
...
\DoxyCodeLine{      .WillOnce(Invoke(DistanceToOrigin));}
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md94}{}\doxysubsection{Sharing Actions}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md94}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md95}{}\doxysection{Misc Recipes on Using Google Mock}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md95}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md96}{}\doxysubsection{Mocking Methods That Use Move-\/\+Only Types}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md96}
...
If you are not happy with the default action, you can tweak it. Depending on what you need, you may either tweak the default action for a specific (mock object, mock method) combination using {\ttfamily O\+N\+\_\+\+C\+A\+L\+L()}, or you may tweak the default action for all mock methods that return a specific type. The usage of {\ttfamily O\+N\+\_\+\+C\+A\+L\+L()} is similar to {\ttfamily E\+X\+P\+E\+C\+T\+\_\+\+C\+A\+L\+L()}, so we’ll skip it and just explain how to do the latter (tweaking the default action for a specific return type). You do this via the {\ttfamily Default\+Value$<$$>$\+::\+Set\+Factory()} and {\ttfamily Default\+Value$<$$>$\+::\+Clear()} A\+PI\+:
...
If you need your mock method to do more than just moving a pre-\/defined value, remember that you can always use {\ttfamily Invoke()} to call a lambda or a callable object, which can do pretty much anything you want\+:
...
Using the tricks covered in this recipe, you are now able to mock methods that take and/or return move-\/only types. Put your newly-\/acquired power to good use -\/ when you design a new A\+PI, you can now feel comfortable using {\ttfamily unique\+\_\+ptrs} as appropriate, without fearing that doing so will compromise your tests.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md97}{}\doxysubsection{Making the Compilation Faster}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md97}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md98}{}\doxysubsection{Forcing a Verification}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md98}
...
{\bfseries{Tip\+:}} The {\ttfamily Mock\+::\+Verify\+And\+Clear\+Expectations()} function returns a {\ttfamily bool} to indicate whether the verification was successful ({\ttfamily true} for yes), so you can wrap that function call inside a {\ttfamily A\+S\+S\+E\+R\+T\+\_\+\+T\+R\+U\+E()} if there is no point going further when the verification has failed.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md99}{}\doxysubsection{Using Check Points}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md99}
...
And that\textquotesingle{}s that.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md101}{}\doxysubsection{Using Google Mock and Threads}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md101}
...
Also, remember that {\ttfamily Default\+Value$<$T$>$} is a global resource that potentially affects {\itshape all} living mock objects in your program. Naturally, you won\textquotesingle{}t want to mess with it from multiple threads or when there still are mocks in action.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md102}{}\doxysubsection{Controlling How Much Information Google Mock Prints}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md102}
...
Now, judiciously use the right flag to enable Google \mbox{\hyperlink{class_mock}{Mock}} serve you better!\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md103}{}\doxysubsection{Gaining Super Vision into Mock Calls}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md103}
...
Then you can type {\ttfamily M-\/m} to start a build, or {\ttfamily M-\/up}/{\ttfamily M-\/down} to move back and forth between errors.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md105}{}\doxysubsection{Fusing Google Mock Source Files}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md105}
Google \mbox{\hyperlink{class_mock}{Mock}}\textquotesingle{}s implementation consists of dozens of files (excluding its own tests). Sometimes you may want them to be packaged up in fewer files instead, such that you can easily copy them to a new machine and start hacking there. For this we provide an experimental Python script {\ttfamily \mbox{\hyperlink{fuse__gmock__files_8py_source}{fuse\+\_\+gmock\+\_\+files.\+py}}} in the {\ttfamily scripts/} directory (starting with release 1.\+2.\+0). Assuming you have Python 2.\+4 or above installed on your machine, just go to that directory and run 
\begin{DoxyCode}{0}
\DoxyCodeLine{python fuse\_gmock\_files.py OUTPUT\_DIR}
\end{DoxyCode}


and you should see an {\ttfamily O\+U\+T\+P\+U\+T\+\_\+\+D\+IR} directory being created with files {\ttfamily \mbox{\hyperlink{gtest_8h_source}{gtest/gtest.\+h}}}, {\ttfamily \mbox{\hyperlink{gmock_8h_source}{gmock/gmock.\+h}}}, and {\ttfamily gmock-\/gtest-\/all.\+cc} in it. These three files contain everything you need to use Google \mbox{\hyperlink{class_mock}{Mock}} (and Google Test). Just copy them to anywhere you want and you are ready to write tests and use mocks. You can use the \href{../scripts/test/Makefile}{\texttt{ scrpts/test/\+Makefile}} file as an example on how to compile your tests against them.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md106}{}\doxysection{Extending Google Mock}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md106}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md107}{}\doxysubsection{Writing New Matchers Quickly}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md107}
...
\end{DoxyEnumerate}\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md108}{}\doxysubsection{Writing New Parameterized Matchers Quickly}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md108}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md110}{}\doxysubsection{Writing New Polymorphic Matchers}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md110}
...
Like in a monomorphic matcher, you may explain the match result by streaming additional information to the {\ttfamily listener} argument in {\ttfamily Match\+And\+Explain()}.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md111}{}\doxysubsection{Writing New Cardinalities}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md111}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md112}{}\doxysubsection{Writing New Actions Quickly}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md112}
...
\end{longtabu}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md113}{}\doxysubsection{Writing New Parameterized Actions Quickly}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md113}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md114}{}\doxysubsection{Restricting the Type of an Argument or Parameter in an A\+C\+T\+I\+ON}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md114}
...
where {\ttfamily Static\+Assert\+Type\+Eq} is a compile-\/time assertion in Google Test that verifies two types are the same.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md115}{}\doxysubsection{Writing New Action Templates Quickly}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md115}
...
Are we using a single-\/template-\/parameter action where {\ttfamily bool} refers to the type of {\ttfamily x}, or a two-\/template-\/parameter action where the compiler is asked to infer the type of {\ttfamily x}?\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md116}{}\doxysubsection{Using the A\+C\+T\+I\+O\+N Object\textquotesingle{}s Type}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md116}
...
Note that we have to pick different suffixes ({\ttfamily Action}, {\ttfamily ActionP}, {\ttfamily Action\+P2}, and etc) for actions with different numbers of value parameters, or the action definitions cannot be overloaded on the number of them.\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md117}{}\doxysubsection{Writing New Monomorphic Actions}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md117}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md118}{}\doxysubsection{Writing New Polymorphic Actions}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md118}
...
\end{DoxyCode}
\hypertarget{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md119}{}\doxysubsection{Teaching Google Mock How to Print Your Values}\label{md_vendor_googletest_googlemock_docs__cook_book_autotoc_md119}
